<div class="row" style="padding:5px 35px 10px 50px ">
		<div class="col-lg-4">
			...
			<div class="row">
				...
				<h3>Tags : <?php echo $states['total']; ?></h3>
				</div>
			</div>
			</div>
		</div>
		<div class="col-lg-4">
			...
			<div class="row">
				...
				<div class="col-lg-8" style="padding:20px;">
				<h3>Active : <?php echo $states['active']; ?></h3>
				</div>
			</div>
			</div>
		</div>
		<div class="col-lg-4">
			...
			<div class="row">
				...
				<div class="col-lg-8" style="padding:20px;">
				<h3>Inactive : <?php echo $states['inactive']; ?></h3>
				</div>
			</div>
			</div>
		</div>
...
<div class="row" style="margin:5px 35px 0px 35px; border: 2px solid #e3e3e3;padding: 15px !important;border-top: 5px solid #fd3768;">
		<div class="col-lg-4">
			<h5 style="color:#fd3768"><strong>Search Tags with Filters?</strong></h5>
		...
		<div class="col-lg-2" style="padding-top:20px">
			<div class="input-group">
			  <select  class="form-control"  ng-model="filter" ng-change="getFilterData()" width="100%" style="height:40px !important">
				...
				<option value="created">BY Description</option>
...
<div class="panel panel-default">
  ...
  <h1 style="color:#2e3458">Tags List</h1>
  <table class="table table-responsive">
    ...
    <tbody>
      ...
      <tr ng-repeat="x in all_question">
		...
		<td>{{x.total_intrest_user}}</td>
		<td>
			<label class="switch">
			  <input type="checkbox"  ng-checked="tags_status(x)" ng-click="myfunc(x)" ng-model="status" >
			  <span class="slider round"></span>
			</label> 
		</td>
		<td>
		<button class="btn btn-danger btn-small" ng-click="delete_tags(x)"><i class="fa fa-trash"></i></button>
		</td>
	  </tr>
