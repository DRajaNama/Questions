...
<div class="container" >
  <div class="row ">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-offset-1 form_area3"
    ...
    <div class="col-lg-4 col-md-4 col-sm-12   form_area3">
	<h2 class="h2"><strong>Sign Up Here!</strong></h2>
	<p class="text-muted">If you have an account? &nbsp; <a href="login" class="text-primary">Login Here!,</a> &nbsp; It takes <br/>less then a minutes</p>
		...
		<form class="form" action="register" method="post">
		  ...
		  <div class="form-group">
			<input class="form_input" name="mobile" type="text" placeholder="Enter Your Mobile No.">
		  ...
		  <div class="form-group">
			<input class="form_input" name="confirm_password" type="password" placeholder="Enter Your Confirm Password">
			<span class="text-danger form_error_confirm_password" style="display:none;"></span>
		  </div>
		  <div class="form-group">
			  <select class="form_input"  name="profession" title="Select Your Profession">
		...
		<center><span class="text-muted"> Sign Up with Social Media sites</span></center>
		<div class="login-or">
        <hr class="hr-or">
		...
		<div class="col-lg-6">
		<center><a href="<?php echo $GoogleLogin; ?>" class="btn btn-default w3-btn" style="width: 130px !important; padding-top:10px;">Google Sign In</a></center>
		</div>
